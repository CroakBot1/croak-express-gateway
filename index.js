...
const { RestClientV5 } = require('bybit-api'); // ✅ Import correct class
...
const client = new RestClientV5({
  ...
  testnet: true, // ✅ Use true for testnet
});
...
app.get('/fetch-positions', async (req, res) => {
  try {
    const result = await client.getPositionInfo({ category: 'linear' }); // ✅ CORRECT METHOD
